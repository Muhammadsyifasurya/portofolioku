    ...
    <>
        ...
        <div className='max-w-[940px] mx-auto p-2 pt-[120px]'>
            ...
            <div className='bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center'>
                <h2 className='text-center'>Muhammad Syifa Surya Saputra</h2>
                <div className='flex'>
                    <a 
                    ...
                    <a 
                        href='https://www.github.com/muhammadsyifasurya'
                        target='_blank'
                        rel='noreferrer'
                    >
            ...
            <div className='text-center py-4 text-xl font-bold uppercase tracking-wider'>
                <div className='hidden sm:block'>
                    <p>
                        Proven Leadership <span className='pxx-1'>|</span> Web Development{' '}
            ...
            <div className='=py-6'>
                <p className='italic'>
                    ...
                    <span className='py-2 italic'>|</span> Dallas, TX
                </p>
