  ...
  return (
    <div className='w-full'>
      <div className='w-screen h-[40vh] relative'>
        <div className='absolute top-0 left-0 w-full h-[54vh] bg-black/90 z-10' />
        <Image
      ...
      <div className='max-w-[100%] h-full mx-auto p-2 grid md:grid-cols-5 gap-8 py-8 absolute bg-white mt-[100px]'>
        <div className='col-span-4 pl-[100px] pr-[100px]'>
          <p>Project</p>
          <h2>Overview</h2>
          <p>
        ...
        <div className='col-span-4 h-[320px] md:col-span-1 shadow-xl shadow-gray-400 rounded-xl py-4 mr-[100px]'>
          <div className='p-2'>
        ...
        <Link href='/#projects'>
          <p className='underline cursor-pointer pl-[100px] mt-[-200px]'>Back</p>
        </Link>
      </div>
    </div>
  )
